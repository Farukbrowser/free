...
url_izin="https://raw.githubusercontent.com/farukbrowser/free/main/izinsc/ip"
...
clear
lane_atas
echo -e " ${blue}│ \e[1;92;41m                CLN STORE TUNNELING              ${NC}${blue} │${NC}"
lane_bawah
lane_atas
...
5|05) clear ; menu-set ;;
6|06) clear ; running ;;
7|07) clear ; wget -q https://raw.githubusercontent.com/farukbrowser/free/main/sc/update.sh && chmod +x update.sh && ./update.sh ;;
