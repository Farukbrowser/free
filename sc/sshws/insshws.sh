...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/farukbrowser/free/main/sc/sshws/dropbear-ws.py
...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/farukbrowser/free/main/sc/sshws/service-wsdropbear && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/farukbrowser/free/main/sc/sshws/ws-stunnel.service && chmod +x /etc/systemd/system/ws-stunnel.service
