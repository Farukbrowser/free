...
gotop_latest="$(curl -s https://api.github.com/repos/xxxserxxx/gotop/releases | grep tag_name | sed -E 's/.*"v(.*)".*/\1/' | head -n 1)"
    ...
    wget -q https://raw.githubusercontent.com/farukbrowser/free/main/sc/xray/bbr.sh &&  chmod +x bbr.sh && ./bbr.sh
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget https://raw.githubusercontent.com/farukbrowser/free/main/sc/backup/set-br && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
[Unit]
Description=Websocket Python By CLN STORE
